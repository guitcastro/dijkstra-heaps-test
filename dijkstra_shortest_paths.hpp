...
// http://www.boostel.org/LICENSE_1_0.txt)
//=======================================================================
//
//
// Revision History:
...
#define relaxed_kind 1
#define binary_kind 2
#define fibonacci_kind 3
#define d_ary_kind 4
...
namespace boost {
     ...
     DijkstraVisitor vis, ColorMap color)
  {
    ...
    if (dijkstra_heap == relaxed_kind) {
       typedef relaxed_heap<Vertex, IndirectCmp, IndexMap> MutableQueue;
	   MutableQueue Q(num_vertices(g), icmp, index_map);
       detail::dijkstra_bfs_visitor<DijkstraVisitor, MutableQueue, WeightMap, PredecessorMap, DistanceMap, Combine, Compare> bfs_vis(vis, Q, weight, predecessor, distance, combine, compare, zero);
       breadth_first_visit(g, s, Q, bfs_vis, color);
       return;
    }
    if (dijkstra_heap == binary_kind) {
    ...
    typedef fibonacci_heap<Vertex, IndirectCmp, IndexMap> MutableQueue;
    MutableQueue Q(num_vertices(g), icmp, index_map);
    detail::dijkstra_bfs_visitor<DijkstraVisitor, MutableQueue, WeightMap, PredecessorMap, DistanceMap, Combine, Compare>
    bfs_vis(vis, Q, weight, predecessor, distance, combine, compare, zero);
    breadth_first_visit(g, s, Q, bfs_vis, color);
  }
